...
public abstract class Query<C extends projectDBConnection> implements Loggable {
    ...
    public <G extends GlobalState<?, C>> List<projectResultSet> executeAndGet(G globalState, String... fills)
            throws Exception {
    ...
    public <G extends GlobalState<?, C>> List<projectResultSet> executeAndGetLogged(G globalState) throws Exception {
        logQueryString(globalState);
